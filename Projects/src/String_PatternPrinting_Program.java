...
class 	Name_PatternPrinting_Program
{
...
{
	//Takes input from user and converts it into char
	System.out.println("GIVE ME ANYTHING IN  UPPERCASE AND I WILL PRINT IN STAR PATTERN");
